...
for lnorm_dict in dicts_list:
    ...
    row_labels = ['tiger', 'zebra', 'gorilla', 'gibbon', 'canone', 'gondola', 'h-disk', 'sc-bus', 'tramcar', 'volcano']
    col_labels = ['tiger', 'zebra', 'gorilla', 'gibbon', 'canone', 'gondola', 'h-disk', 'sc-bus', 'tramcar', 'volcano']
